((ace-jump-mode :source "elpaca-menu-lock-file" :recipe
 ...
 (anki :source "elpaca-menu-lock-file" :recipe
       (:source "elpaca-menu-lock-file" :package "anki" :id anki :host
                github :repo "chenyanming/anki.el" :build
 ...
 (cyberpunk-2019-theme :source "elpaca-menu-lock-file" :recipe
                       (:package "cyberpunk-2019-theme" :fetcher
                                 github :repo
                                 "the-frey/cyberpunk-2019" :files
                                 ("*.el" "*.el.in" "dir" "*.info"
                                  "*.texi" "*.texinfo" "doc/dir"
                                  "doc/*.info" "doc/*.texi"
                                  "doc/*.texinfo" "lisp/*.el"
 ...
 (cyberpunk-theme :source "elpaca-menu-lock-file" :recipe
                  (:package "cyberpunk-theme" :fetcher github :repo
                            "n3mo/cyberpunk-theme.el" :files
                            ("*.el" "*.el.in" "dir" "*.info" "*.texi"
                             "*.texinfo" "doc/dir" "doc/*.info"
                             "doc/*.texi" "doc/*.texinfo" "lisp/*.el"
                             "docs/dir" "docs/*.info" "docs/*.texi"
 ...
 (fontaine :source "elpaca-menu-lock-file" :recipe
           (:package "fontaine" :repo "protesilaos/fontaine" :tar
                     ...
                     ("*"
                      (:exclude ".git" "COPYING" "doclicense.texi"))
                     :source "elpaca-menu-lock-file" :id fontaine
                     :type git :protocol https :inherit t :depth
                     treeless :ref
 ...
 (mu4e-dashboard :source "elpaca-menu-lock-file" :recipe
                 (:source "elpaca-menu-lock-file" :package
                          "mu4e-dashboard" :id mu4e-dashboard :host
                          github :repo "rougier/mu4e-dashboard" :type
                          git :protocol https :inherit t :depth
                          treeless :ref
 ...
 (nano-mu4e :source "elpaca-menu-lock-file" :recipe
            (:source "elpaca-menu-lock-file" :package "nano-mu4e" :id
                     nano-mu4e :host github :repo "rougier/nano-mu4e"
                     :type git :protocol https :inherit t :depth
                     treeless :ref
 ...
 (org-msg :source "elpaca-menu-lock-file" :recipe
          (:source "elpaca-menu-lock-file" :package "org-msg" :id
                   org-msg :host github :repo
                   "jeremy-compostella/org-msg" :type git :protocol
                   https :inherit t :depth treeless :ref
