...
(when (fboundp 'repeatable-wrap)
  (general-define-key
   ...
   "g" (repeatable-wrap zetta-org-go)
   "j" (repeatable-wrap org-next-visible-heading)
   "k" (repeatable-wrap org-previous-visible-heading)
   "U" (repeatable-wrap outline-up-heading)
   "J" (repeatable-wrap org-move-subtree-down)
   "K" (repeatable-wrap org-move-subtree-up)

   "a" (repeatable-wrap zetta-org-append)
   "T" (repeatable-wrap zetta-org-append-todo)
   "8" (repeatable-wrap org-toggle-heading)
   "o" 'org-capture
   "z" (repeatable-wrap org-add-note)
   "S" (repeatable-wrap org-schedule)
   "D" (repeatable-wrap org-deadline)
   "t" (repeatable-wrap call-zetta-org-todo-with-prefix)

   "h" (repeatable-wrap org-metaleft)
   "H" (repeatable-wrap org-shiftmetaleft)
   "l" (repeatable-wrap org-metaright)
   "L" (repeatable-wrap org-shiftmetaright)
   "-" (repeatable-wrap org-cycle-list-bullet)
   "r" (repeatable-wrap org-refile)
   "A" (repeatable-wrap org-archive-subtree)
   "s" (repeatable-wrap org-sort)
   "q" (repeatable-wrap org-columns-quit)

   "TAB" (repeatable-wrap org-cycle)
   "S-TAB" (repeatable-wrap org-global-cycle)
   "i" (repeatable-wrap org-tree-to-indirect-buffer)
   "G" (repeatable-wrap org-sparse-tree)

   "m" (repeatable-wrap org-mark-element)
   "M" (repeatable-wrap org-mark-subtree)
   "C-t" (repeatable-wrap zetta-org-call-tangle-with-prefix)
   "C-S-t" (repeatable-wrap org-babel-tangle)))
