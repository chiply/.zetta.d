...
;; NOTE (added by Charlie Holland, not the author): Big utility of
;; this, despite being a 'just for fun' package is that you can see if
;; emacs is frozen without having to press any keys

;; NOTE (added by Charlie Holland, not the author): Pauses when
