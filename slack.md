...
```
machine REMOVED-WORKSPACE.slack.com login alice@example.com password xoxc-1234567890-...
machine REMOVED-WORKSPACE.slack.com login alice@example.com^cookie password d=xoxd-abc123...
```
...
(slack-register-team
 ...
 :token (auth-source-pick-first-password
         :host "REMOVED-WORKSPACE.slack.com"
