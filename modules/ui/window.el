...
(general-define-key
 ...
 "D" (repeatable-wrap delete-window)
 "C-S-d" (repeatable-wrap delete-other-windows)
 "C-S-S" (repeatable-wrap window-toggle-side-windows)
 "C-S-b h" (repeatable-wrap horizontal-scroll-bar-mode)
 "mm" (repeatable-wrap balance-windows)
 "mk" (repeatable-wrap minimize-window)
 "mj" (repeatable-wrap maximize-window)
 "C-v" (repeatable-wrap visual-line-mode)
 "C-t" (repeatable-wrap toggle-truncate-lines)
 "C-t" (repeatable-wrap toggle-truncate-lines)
 "C-w" (repeatable-wrap toggle-word-wrap)
 "s" (repeatable-wrap zetta-state-hydra/body)
 "f" (repeatable-wrap consult-project-extra-find)
 "F" (repeatable-wrap find-file)
 "x" (repeatable-wrap execute-extended-command)
 "u" (repeatable-wrap winner-undo)
 "o" (repeatable-wrap zetta-window-divider-mode)
 "C-S-b b" (repeatable-wrap zetta-scroll-bar-mode)
 "r h" (repeatable-wrap zetta-shrink-window-h-1)
 "r C-h" (repeatable-wrap zetta-shrink-window-h-2)
 "r C-S-h" (repeatable-wrap zetta-shrink-window-h-4)
 "r l" (repeatable-wrap zetta-enlarge-window-h-1)
 "r C-l" (repeatable-wrap zetta-enlarge-window-h-2)
 "r C-S-l" (repeatable-wrap zetta-enlarge-window-h-4)
 "r j" (repeatable-wrap zetta-shrink-window-v-1)
 "r C-j" (repeatable-wrap zetta-shrink-window-v-2)
 "r C-S-j" (repeatable-wrap zetta-shrink-window-v-4)
 "r k" (repeatable-wrap zetta-enlarge-window-v-1)
 "r C-k" (repeatable-wrap zetta-enlarge-window-v-2)
 "r C-S-k" (repeatable-wrap zetta-enlarge-window-v-4)
 )
...
(general-define-key
 ...
 "r" (repeatable-wrap window-toggle-side-windows)
 )
