...
(defun convention-start-container-format-code-mount-frag ()
  ...
  (if (equal (completing-read "Mount a code directory? " '("no" "yes")) "yes")
...
(defun convention-start-container-format-data-mount-frag ()
  ...
  (if (equal (completing-read "Mount a data directory? " '("no" "yes")) "yes")
...
(defun convention-start-container-format-config-mount-frag ()
  ...
  (if (equal (completing-read "Mount a config directory? " '("no" "yes")) "yes")
...
(defun convention-start-container-format-port-map-frag ()
  ...
  (if (equal (completing-read "Set up port forwarding? " '("no" "yes")) "yes")
      (concat "-p "
...
(defun convention-start-container-format-name-frag (image)
  ...
  (let ((name-prefix (string-trim (concat
                                   "convention-"
                                   (nth 0 (split-string
