...
(general-define-key
 ...
 "r h" (repeatable-lite-wrap (lambda () (interactive) (shrink-window-horizontally 1)))
 "r C-h" (repeatable-lite-wrap (lambda () (interactive) (shrink-window-horizontally 2)))
 "r C-S-h" (repeatable-lite-wrap (lambda () (interactive) (shrink-window-horizontally 4)))
 "r l" (repeatable-lite-wrap (lambda () (interactive) (enlarge-window-horizontally 1)))
 "r C-l" (repeatable-lite-wrap (lambda () (interactive) (enlarge-window-horizontally 2)))
 "r C-S-l" (repeatable-lite-wrap (lambda () (interactive) (enlarge-window-horizontally 4)))
 "r j" (repeatable-lite-wrap (lambda () (interactive) (shrink-window 1)))
 "r C-j" (repeatable-lite-wrap (lambda () (interactive) (shrink-window 2)))
 "r C-S-j" (repeatable-lite-wrap (lambda () (interactive) (shrink-window 4)))
 "r k" (repeatable-lite-wrap (lambda () (interactive) (enlarge-window 1)))
 "r C-k" (repeatable-lite-wrap (lambda () (interactive) (enlarge-window 2)))
 "r C-S-k" (repeatable-lite-wrap (lambda () (interactive) (enlarge-window 4)))
 )
